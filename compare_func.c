...
int s21_is_greater(s21_decimal value_1, s21_decimal value_2) {
  // int result, check = 0;
  // int sign_1 = get_sign(value_1);
  // int compare = is_greater_or_not(value_1, value_2, &result, &check, sign_1,
  // 0);
  // if (check) {
  //   if (!sign_1)
...
int s21_is_greater_or_equal(s21_decimal value_1, s21_decimal value_2) {
  ...
  //   int sign_1 = get_sign(value_1);
  //   int compare =
  //       is_greater_or_not(value_1, value_2, &result, &check, sign_1, 0);
  //   if (check) {
  //     if (!sign_1)
  //       result = compare >= 0 ? 1 : 0;
  //     else
...
int s21_is_less_or_equal(s21_decimal value_1, s21_decimal value_2) {
  ...
  //   int sign_1 = get_sign(value_1);
  //   int compare =
  //       is_greater_or_not(value_1, value_2, &result, &check, sign_1, 1);
  //   if (check) {
  //     if (!sign_1)
  //       result = compare <= 0 ? 1 : 0;
  //     else
