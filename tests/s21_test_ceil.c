...
START_TEST(s21_test_ceil_check_1) {
  ck_assert_ldouble_eq_tol(s21_ceil(-5.45), ceil(-5.45));
}
END_TEST
...
START_TEST(s21_test_ceil_check_3) {
  ck_assert_ldouble_eq_tol(s21_ceil(S21_NAN), ceil(NAN));
}
END_TEST

START_TEST(s21_test_ceil_check_4) {
  ck_assert_ldouble_eq_tol(s21_ceil(S21_INF_NEG), ceil(-INFINITY));
}
END_TEST

START_TEST(s21_test_ceil_check_5) {
  ck_assert_ldouble_eq_tol(s21_ceil(S21_INF_POS), ceil(INFINITY));
}
END_TEST
