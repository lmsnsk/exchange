...
START_TEST(s21_test_floor_check_1) {
  ck_assert_ldouble_eq_tol(s21_floor(-5.45), floor(-5.45));
}
END_TEST
...
START_TEST(s21_test_floor_check_3) {
  ck_assert_ldouble_eq_tol(s21_floor(S21_NAN), floor(NAN));
}
END_TEST

START_TEST(s21_test_floor_check_4) {
  ck_assert_ldouble_eq_tol(s21_floor(S21_INF_NEG), floor(-INFINITY));
}
END_TEST

START_TEST(s21_test_floor_check_5) {
  ck_assert_ldouble_eq_tol(s21_floor(S21_INF_POS), floor(INFINITY));
}
END_TEST
